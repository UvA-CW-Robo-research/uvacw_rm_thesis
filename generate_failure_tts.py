"""
Generates, plays, and saves failure condition audio files.
Reads content from texts/failure.json.

Run with Python 3 (outside nao_env):
    python3 generate_failure_tts.py
...
# Glitch voice — subtle stutter feel, less expressive, still warm
...
def generate_tts(text: str, voice_type: str = "default") -> bytes:
    settings = VOICE_SETTINGS_GLITCH if voice_type == "glitch" else VOICE_SETTINGS_DEFAULT
