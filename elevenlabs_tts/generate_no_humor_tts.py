"""
Generates, plays, and saves no-humor condition audio files.
Reads content and delivery metadata from texts/no_humor.json.

Run with Python 3 (outside nao_env):
    python3 generate_no_humor_tts.py
...
TEXTS_FILE    = os.path.join(PROJECT_ROOT, "texts", "no_humor.json")
...
if __name__ == "__main__":
    ...
    with open(TEXTS_FILE, "r") as f:
        no_humor_lines = json.load(f)

    for key, item in no_humor_lines.items():
        print("\n[{}]".format(key))
