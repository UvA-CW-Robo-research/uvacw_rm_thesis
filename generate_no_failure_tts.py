"""
Generates, plays, and saves no-failure condition audio files.
Reads content from texts/no_failure.json.

Run with Python 3 (outside nao_env):
    python3 generate_no_failure_tts.py
...
TEXTS_FILE    = "texts/no_failure.json"
